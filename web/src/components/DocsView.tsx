...
// static HTML (`./api/`), published alongside this site under /numpy/api/.
//
...
export function DocsView() {
  ...
  return (
    <section className="view active" id="view-docs">
      ...
      <p className="muted">The full API reference for <code>{lib.pkg}</code> (package <code>numpy</code>) is generated from the source with a dependency-free <code>go/doc</code> tool (committed in the repo under <code>docs/gen</code>) and rendered inline below.</p>
