...
// the GitHub Releases API for malcolmston/numpy.
const RELEASE_LIBS: RelLib[] = [
  { name: NUMPY.name, icon: NUMPY.icon, accent: NUMPY.accent, repo: ghrepo(NUMPY), url: NUMPY.repo },
];
