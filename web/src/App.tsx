...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/numpy', initials: 'np', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/numpy</span> — NumPy-style n-dimensional arrays, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of NumPy</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/numpy" footer={footer}>
